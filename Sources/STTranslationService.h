...
typedef BOOL (^STTranslationEligibility)(void);
...
- (void)translateText:(NSString *)text source:(NSString *)source target:(NSString *)target bypassCache:(BOOL)bypassCache eligibility:(nullable STTranslationEligibility)eligibility completion:(STTranslationCompletion)completion;
@end
