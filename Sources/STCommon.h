...
FOUNDATION_EXPORT NSString * const STCacheClearedDarwinNotification;
FOUNDATION_EXPORT NSString * const STPreferenceDomain;

FOUNDATION_EXPORT NSString *STJBRootPath(NSString *relativePath);
FOUNDATION_EXPORT void STWithFileLock(NSString *lockPath, dispatch_block_t block);
...
FOUNDATION_EXPORT NSString *STCurrentPageIdentity(void);
