...
- (void)presentControlPanelWithContinuousActive:(BOOL)continuousActive chatActive:(BOOL)chatActive {
    ...
    [sheet addAction:[UIAlertAction actionWithTitle:@"提示设置位置" style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) { [self.delegate overlayManager:self didRequestConfiguredAction:@"settings"]; }]];
