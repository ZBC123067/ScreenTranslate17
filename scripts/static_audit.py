...
require("Version: 0.4.2" in control and "ScreenTranslate17 0.4.2" in readme, "version strings are inconsistent")
require(info.get("CFBundleShortVersionString") == "0.4.2", "preference bundle version is inconsistent")
...
require("isController = 1" in entry, "PreferenceLoader entry is not marked as a preference-bundle controller")
