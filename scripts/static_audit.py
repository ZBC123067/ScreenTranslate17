...
require(not (ROOT / "layout").exists(), "legacy layout directory duplicates PreferenceLoader staging")
require("Architecture: iphoneos-arm64e" in control, "control architecture is not arm64e")
require("Version: 0.4.0" in control and "ScreenTranslate17 0.4.0" in readme, "version strings are inconsistent")
require(info.get("CFBundleShortVersionString") == "0.4.0", "preference bundle version is inconsistent")
...
for marker in ["ar -x", "data.tar.*", "PreferenceLoader", "lipo -archs", "ScreenTranslate17Prefs"]:
